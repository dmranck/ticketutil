...
class TestJiraTicket(TestCase):
    ...
    def test_edit(self, mock_session, mock_url, mock_fields):
        ...
        self.assertEqual(request_result, SUCCESS_RESULT._replace(url=mock_url.return_value, ticket_content=MOCK_RESULT))
    ...
    def test_remove_all_watchers(self, mock_session, mock_url, mock_get_list):
        ...
        self.assertEqual(request_result, RETURN_RESULT('Success', None, mock_url.return_value, MOCK_RESULT, watchers))
