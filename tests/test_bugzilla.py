...
class FakeSession(object):
    ...
    def get(self, url):
        ...
        elif TICKET_ID in url:
            return FakeResponseTicketID(status_code=self.status_code, text=self.text)
        elif url.endswith('/rest/login'):
...
class FakeResponseTicketID(FakeResponse):
